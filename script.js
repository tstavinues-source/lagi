...
const QUIZ_SETS = {
  A: {
    ...
    questions: [
      ...
      { no: 4, ja: "ずは Cがた フレームの プレスきかいです", id: "Gambar tersebut adalah mesin press dengan rangka (frame) tipe C.", answer: true },
      ...
      { no: 8, ja: "ずの Aのぶぶんは がいけいぬきで かこうします", id: "Bagian A pada gambar diproses dengan pemotongan bentuk luar (outline blanking).", answer: false },
      ...
      { no: 11, ja: "ずの プレスきかいに かながたを とりつけるときは うわがたから こていします", id: "Saat memasang cetakan pada mesin press, pemasangan dimulai dari fiksasi cetakan atas (upper die) terlebih dahulu.", answer: true },
      ...
      { no: 16, ja: "パンチとダイのクリアランスがおおきいと ずのようににじせんだんめんが できます", id: "Jika clearance antara punch dan die besar, akan terbentuk permukaan geser ganda seperti pada gambar.", answer: false },
  ...
  B: {
    ...
    questions: [
      ...
      { no: 3, ja: "ずのような りょうてそうさしきあんぜんそうちの おしボタンのかんかくAは 300mmいじょうです", id: "Pada alat pengaman kontrol dua tangan seperti gambar, jarak antar tombol tekan A adalah 300mm atau lebih.", answer: true },
      { no: 4, ja: "ずは Cがた フレームの プレスきかいです", id: "Gambar tersebut adalah mesin press dengan rangka tipe C.", answer: true },
      ...
      { no: 7, ja: "ずの せいひんは しぼりがたによって つくられます", id: "Produk pada gambar dibuat dengan menggunakan cetakan penarikan (drawing die).", answer: false },
      ...
      { no: 10, ja: "ずの うちぬきかじゅうは パンチに シャーかく（けいしゃかく）を つけても ちいさく なりません", id: "Beban pemotongan pada gambar tidak akan berkurang meskipun punch diberi sudut geser (shear angle).", answer: false },
      { no: 11, ja: "ずの プレスきかいに かながたを とりつけるときには したがたから さきに こていします", id: "Saat memasang cetakan pada mesin press, pemasangan dimulai dari fiksasi cetakan bawah terlebih dahulu.", answer: false },
      ...
      { no: 14, ja: "ずのような Vまげかこうを するとき まげダイのかたはば Wは いたあつtの 6～8ばいていどに します", id: "Saat melakukan penekukan V seperti pada gambar, lebar bahu die tekuk W dibuat sekitar 6-8 kali ketebalan pelat (t).", answer: true },
      ...
      { no: 19, ja: "このひょうしきが あるところには はいっては いけません", id: "Tempat yang terdapat tanda (simbol larangan masuk) ini tidak boleh dimasuki.", answer: true },
  ...
  C: {
    ...
    questions: [
      ...
      { no: 3, ja: "ずの Aは ダイクッション です", id: "A pada gambar adalah die cushion.", answer: true },
      { no: 4, ja: "ずの プレスきかいの ダイハイトは Aです", id: "Tinggi cetakan (die height) mesin press pada gambar ditunjukkan oleh A.", answer: true },
      ...
      { no: 10, ja: "ずの プレスきかいに かながたを とりつけるときには したがたから さきに こていします", id: "Saat memasang cetakan pada mesin press, pemasangan dimulai dari fiksasi cetakan bawah terlebih dahulu.", answer: false },
      { no: 11, ja: "ずの かながたは Vまげがたです", id: "Cetakan pada gambar adalah cetakan tekuk tipe V (V-bend die).", answer: true },
      { no: 12, ja: "しぼりダイの Rは ダイラジアスとも いいます", id: "R pada die penarikan juga disebut die radius.", answer: true },
      { no: 13, ja: "ずの うちぬきせいひんの Aは バリです", id: "A pada produk hasil pemotongan di gambar adalah burr (sisa tajam).", answer: false },
      ...
      { no: 15, ja: "バーリングかこうとは ずのような かこうを いいます", id: "Proses burring adalah proses pembuatan lubang berbibir/berflensa seperti pada gambar.", answer: true },
  ...
  D: {
    ...
    questions: [
      ...
      { no: 2, ja: "ずのような りょうてそうさしきあんぜんそうちの おしボタンのかんかくAは 200mmです", id: "Pada alat pengaman kontrol dua tangan, jarak antar tombol tekan A adalah 200mm.", answer: false },
      ...
      { no: 5, ja: "ずの Aは プレスきかいの フレームです", id: "A pada gambar adalah rangka (frame) mesin press.", answer: false },
      { no: 6, ja: "ずの ぶひんの かこうは Vまげかこうが てきしています", id: "Proses pembuatan komponen pada gambar cocok menggunakan proses tekuk V (V-bending).", answer: false },
      { no: 7, ja: "ずの Aの ぶぶんは せんだんめんです", id: "Bagian A pada gambar adalah permukaan geser (shear surface).", answer: true },
      ...
      { no: 14, ja: "バーリングかこうでは したあなの バリがわから かこうすると われが でにくいです", id: "Pada proses burring, jika diproses dari sisi burr lubang awal (pilot hole), retak akan lebih sulit terjadi.", answer: true },
      { no: 15, ja: "Uまげかこうで ずのような うちがわに とじる じょうたいを スプリングゴーといいます", id: "Pada proses tekuk U, kondisi menutup ke arah dalam seperti pada gambar disebut spring-go.", answer: true },
  ...
  E: {
    ...
    questions: [
      ...
      { no: 6, ja: "うちぬきりょくは ずの パンチの めんせきを きじゅんに けいさんします", id: "Gaya pemotongan (blanking force) dihitung berdasarkan luas penampang punch seperti pada gambar.", answer: false },
      { no: 7, ja: "ずの Aの ぶぶんは ダレです", id: "Bagian A pada gambar adalah bagian 'dare' (rollover / pembulatan tepi akibat proses pemotongan).", answer: true },
      ...
      { no: 9, ja: "ずの うちぬきかじゅうは パンチにシャーかく（けいしゃかく）を つけると ちいさくなります", id: "Beban pemotongan pada gambar akan berkurang jika punch diberi sudut geser (shear angle).", answer: true },
      { no: 10, ja: "ずの プレスきかいに かながたをとりつけるときは うわがたから こていします", id: "Saat memasang cetakan pada mesin press, pemasangan dimulai dari fiksasi cetakan atas terlebih dahulu.", answer: true },
      { no: 11, ja: "ずの Aは うちぬきようの クリアランスです", id: "A pada gambar adalah clearance untuk proses pemotongan (blanking).", answer: false },
      ...
      { no: 15, ja: "いたあつが うすいと ずのように しぼりかこうで しわが でることが あります", id: "Jika ketebalan pelat tipis, kerutan dapat muncul pada proses penarikan (drawing) seperti pada gambar.", answer: true },
      { no: 16, ja: "ほそながいぶひんを Vまげかこうすると ずのような そりが でやすいです", id: "Jika komponen yang panjang dan sempit ditekuk-V, kelengkungan (warp) seperti pada gambar mudah terjadi.", answer: true },
  ...
  F: {
    ...
    questions: [
      ...
      { no: 4, ja: "ずの プレスきかいの ダイハイトはA です", id: "Tinggi cetakan (die height) mesin press pada gambar ditunjukkan oleh A.", answer: true },
      ...
      { no: 7, ja: "ずの ぶひんの かこうは Vまげかこうが てきしています", id: "Proses pembuatan komponen pada gambar cocok menggunakan proses tekuk V.", answer: false },
      ...
      { no: 12, ja: "ずのうちぬきかじゅうは パンチにシャーかく（けいしゃかく）をつけても ちいさくなりません", id: "Beban pemotongan pada gambar tidak akan berkurang meskipun punch diberi sudut geser (shear angle).", answer: false },
      ...
      { no: 14, ja: "ずの うちぬきせいひんの Aは バリです", id: "A pada produk hasil pemotongan di gambar adalah burr (sisa tajam).", answer: false },
      ...
      { no: 16, ja: "ほそながいぶひんを Vまげかこうすると ずのような そりが でやすいです", id: "Jika komponen yang panjang dan sempit ditekuk-V, kelengkungan seperti pada gambar mudah terjadi.", answer: true },
      ...
      { no: 19, ja: "このひょうしきが あるところは あんぜんです", id: "Tempat yang terdapat tanda peringatan (segitiga seru) ini aman.", answer: false },
  ...
  G: {
    ...
    questions: [
      ...
      { no: 2, ja: "下の図のプレス機械のダイハイトの寸法はAです。", id: "Dimensi tinggi cetakan (die height) mesin press pada gambar ditunjukkan oleh A.", answer: true },
      ...
      { no: 5, ja: "下の図のようなV曲げ加工するときは曲げダイの肩幅Wは板厚Tよりも大きくします。", id: "Saat melakukan penekukan V seperti pada gambar, lebar bahu die tekuk W dibuat lebih besar daripada ketebalan pelat T.", answer: true },
      { no: 6, ja: "曲げ半径が大きいほどスプリングバックも大きくなります。", id: "Semakin besar radius tekuk, semakin besar pula springback yang terjadi.", answer: true },
      { no: 7, ja: "下の図のAの部分は四角のパンチで抜きます。", id: "Bagian A pada gambar dilubangi menggunakan punch berbentuk persegi.", answer: false },
      ...
      { no: 14, ja: "下の図の打ち抜き製品のAはバリです。", id: "A pada produk hasil pemotongan di gambar adalah burr (sisa tajam).", answer: false },
